...
(defun set-buffer-eol-conversion-unix ()
  ...
  ;; TEMP HACK BY RNC - ENSURE ^M ARE STRIPPED
  (dos-to-unix)
  ;; The problem appears to be that inhibiting the eol-conversion ability
  ;; causes the encode/decode coding system problems. Have not currently time
  ;; to investigate whether could switch it on and off again to get it working.
  )
