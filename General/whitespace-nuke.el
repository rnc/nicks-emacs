...
;; Copyright (C) 1995, 1996, 1997 Noah S. Friedman
...
;; $Id: whitespace.el,v 1.1 2003/08/01 12:56:23 rnc Exp $
      ...
      (save-restriction
        (save-match-data
          ...
          (cond
           ...
           (t
;; RNC ADDED 16/3/1999
	    (if (and (re-search-forward whitespace-regexp nil t)
		     (y-or-n-p
		      (format "Remove trailing spaces in buffer %s? " (buffer-name))))
		(progn
		  (goto-char (point-min))
